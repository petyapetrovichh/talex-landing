...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-primary selection:text-white font-sans">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 border-b border-black/5" style={{backgroundImage: 'url(/images/hero-background.png)', backgroundSize: 'cover', backgroundPosition: 'center right', backgroundAttachment: 'fixed'}}>
