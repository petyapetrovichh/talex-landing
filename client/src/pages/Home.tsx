...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-primary selection:text-white font-sans">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 border-b border-black/5 relative md:bg-cover" style={{backgroundImage: window.innerWidth < 768 ? 'url(/images/hero-mobile-bg.png)' : 'url(/images/hero-background.png)', backgroundSize: window.innerWidth < 768 ? 'cover' : '110% 110%', backgroundPosition: 'center', backgroundAttachment: window.innerWidth < 768 ? 'fixed' : 'scroll', minHeight: '100vh'}}>
        {/* Mobile Hero Content */}
